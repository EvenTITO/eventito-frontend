...
import {apiGetEventMembersByRole} from "@/services/api/eventServices.js";
...
export default function EventConfigurationMembers() {
    ...
    const [editedMembers, setEditedMembers] = useState(location.state.editedMembers ? location.state.editedMembers : location.state.members);
    ...
    const handleSearchText = (event) => {
        ...
        if (tab === "organizadores") {
            ...
            let showOrganizers = allOrganizers
                .filter(o => o.organizers.name.toLowerCase().includes(lowerText) ||
                    o.organizers.lastname.toLowerCase().includes(lowerText) ||
                    o.organizers.email.toLowerCase().includes(lowerText));
                ...
                <div
                    ...
                    <nav className="grid gap-4 text-sm text-muted-foreground" x-chunk="dashboard-04-chunk-0">
                        <Link to={`/events/${id}/configuration`}
                              state={{...location.state, editedMembers: editedMembers}}>
                            General
                        </Link>
