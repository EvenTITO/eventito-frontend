export const apiGetWorksByTrack = async (
  ...
  return (await httpClient.get(`/${eventId}/works`, { track, offset, limit }))
    .data
}
...
export const apiGetWorkDownloadURL = async (httpClient, eventId, workId) => {
  return (
    await httpClient.get(`/${eventId}/works/${workId}/submissions/latest`)
  ).data
}
...
export const apiGetSubmissionUploadUrl = async (
  httpClient,
  eventId,
  workId
) => {
