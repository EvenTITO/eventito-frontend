...
const PopupContent = React.forwardRef(({ className, children, ...props }, ref) => {
  const containerStyles = "fixed right-0 top-[50%] z-50 grid h-full min-w-[500px] max-w-full translate-x-0 translate-y-[-50%] gap-4 border bg-background shadow-lg p-4 h-full flex flex-col";


  const animation = "duration-1000 data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 data-[state=closed]:slide-out-to-right-[100%] data-[state=open]:slide-in-from-right-[100%] data-[state=open]:slide-in-from-top-[50%] data-[state=closed]:slide-out-to-top-[50%]";
